...
// import { IFonts, fonts, IFont } from "../modules/CSS/fonts";
// import { makeThemeReducer, defaultThemes } from "../modules/themes";
...
//     private static _routes: IAppInitOptions["routes"] = [];
//     private static _socials: IAppInitOptions["socials"] = [];
//     private static _history = createBrowserHistory();
//     private static _fonts: IAppInitOptions["fonts"];
//     private static _store: Store<Required<IAppInitOptions["defaultState"]>>;
//     private static _themes: IAppInitOptions["themes"];
...
//         fonts,
//         themes = {
//             light: { name: "light", colors: defaultThemes.light.colors },
//             dark: { name: "dark", colors: defaultThemes.dark.colors },
//         },
//         reducers = {},
//         defaultState,
//         version,
