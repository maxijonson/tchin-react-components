...
export default () => (
    <>
        ...
        <P>
            This is the original solution TRC gives you. By giving the Drawer an{" "}
            <CodeSpan>id</CodeSpan> prop, it will add an event listener for that{" "}
            <CodeSpan>id</CodeSpan>. Use the <CodeSpan>toggleDrawer</CodeSpan>{" "}
            function that is exported along with the Drawer component to
            dispatch the toggle event with the <CodeSpan>id</CodeSpan> you
            provided.
        </P>
        ...
        <P>
            This prop takes a function that is called whenever the Drawer gets
            an internal event to close itself (i.e. Clicking on the overlay
        ...
        <P>
            ...
            when the user triggers an exit event, the Drawer will close itself.
            However, if you would like to prevent this, defining{" "}
            <CodeSpan>onRequestClose</CodeSpan> will give you the{" "}
            <CodeSpan>toggle</CodeSpan> function so you can call it yourself, or
            not.
        </P>
        <CodeSnippet>{rawEventBased}</CodeSnippet>
        <P>
            For StateBased Drawers, if you want your users to be able to close
            the Drawer when they trigger an exit event, you need to define the{" "}
            <CodeSpan>onRequestClose</CodeSpan> prop and set your state inside
            this function. Note that you do not get the{" "}
            <CodeSpan>toggle</CodeSpan> function passed as parameter, since that
            function manages the internal Drawer state, which is useless for a
            StateBased Drawer.
        </P>
